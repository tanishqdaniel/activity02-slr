...
1. What are the dimensions of the dataset?
   - In this data set there are 1458 observations and 123 variables
  What does each row represent?
  - Each row represents a countries personal freedom score and the variables its based on as well as the year the data was recorded in.
...
hfi_2016 %>% 
  ggplot(aes(x=countries,
             y=pf_score)) +
  geom_point()+
  labs(title = "pf_score by country",
       x = "Country",
       y = "pf_score")
```
